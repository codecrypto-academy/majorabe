...
fs.createReadStream("./data/" + args.data) // Crea un flujo de lectura desde el archivo de datos original a cifrar.
    .pipe(cifrador) // Aplica el proceso de cifrado utilizando la instancia del cifrador AES.
    .pipe(new fs.createWriteStream("./data/" + args.public + "-" + args.data + ".enc")); // Escribe los datos cifrados en el archivo de salida con extensión .enc.
